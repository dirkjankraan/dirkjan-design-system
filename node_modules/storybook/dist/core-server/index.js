import CJS_COMPAT_NODE_URL_nforufg574a from 'node:url';
import CJS_COMPAT_NODE_PATH_nforufg574a from 'node:path';
import CJS_COMPAT_NODE_MODULE_nforufg574a from "node:module";

var __filename = CJS_COMPAT_NODE_URL_nforufg574a.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_nforufg574a.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_nforufg574a.createRequire(import.meta.url);
...
import {
  toEstree
} from "../_node-chunks/chunk-EJXPD5ZO.js";
import {
  StatusTypeIdMismatchError
} from "../_node-chunks/chunk-S6DHAEF6.js";
import {
  debounce,
  generateStoryFile,
  getErrorLevel,
  ...
  useStatics,
  withTelemetry
} from "../_node-chunks/chunk-YZM6KGCT.js";
import {
  detectPnp
} from "../_node-chunks/chunk-FUIDNDU3.js";
import "../_node-chunks/chunk-CHIH72L6.js";
import {
  StorybookError
} from "../_node-chunks/chunk-I4RZMZ3E.js";
import {
  telemetry
} from "../_node-chunks/chunk-FXNR5YSW.js";
import "../_node-chunks/chunk-NPXAZAVS.js";
import {
...
} from "../_node-chunks/chunk-UT3WQUMU.js";
import "../_node-chunks/chunk-4AQONV22.js";
import "../_node-chunks/chunk-BQD7F6RA.js";
import {
  require_pretty_hrtime
} from "../_node-chunks/chunk-ODUSNBK2.js";
import "../_node-chunks/chunk-3OHPHY2X.js";
import "../_node-chunks/chunk-HR5IATTB.js";
import {
  invariant,
  up2 as up
} from "../_node-chunks/chunk-XCLV4BMV.js";
import "../_node-chunks/chunk-VY5BQ7TC.js";
import {
  importModule,
  resolvePackageDir
} from "../_node-chunks/chunk-DZ7OHHOW.js";
import {
  dirname,
  join,
  relative,
  resolve
} from "../_node-chunks/chunk-U3ALJSR6.js";
import {
  slash
} from "../_node-chunks/chunk-4DRFQVSZ.js";
import "../_node-chunks/chunk-GD7NSSSF.js";
import {
  Tag
} from "../_node-chunks/chunk-VPJWR2LJ.js";
import {
  require_dist
} from "../_node-chunks/chunk-PLM3RH2Q.js";
import {
  require_lib,
  require_src
} from "../_node-chunks/chunk-LYIJ2R4C.js";
import {
  require_picocolors
} from "../_node-chunks/chunk-WZ365ROL.js";
import {
  __commonJS,
  __require,
  __toESM
} from "../_node-chunks/chunk-5NCA6CFR.js";
...
async function getManagerBuilder() {
  return await import("../_node-chunks/builder-manager-MHSTSER3.js");
}
  ...
  async function onChangeOrRemove(absolutePath, removed) {
    ...
    !removed && isDirectory(absolutePath) && await Promise.all(
      specifiers.filter((specifier) => importPath.startsWith(specifier.directory)).map(async (specifier) => {
        ...
        ), { globby } = await import("../_node-chunks/globby-XM3OX45H.js");
...
var getAttr = (elt, what) => elt.attributes.find((n) => n.type === "JSXAttribute" && n.name.name === what), getAttrValue = (elt, what) => getAttr(elt, what)?.value, getAttrLiteral = (elt, what) => {
  ...
  let store = {
    ...
    metaTags: void 0,
    imports: void 0
  }, { compile } = await import("../_node-chunks/mdx-N42X6CFJ-7BDD6HH7.js");
  await compile(code, {
...
var makeAbsolute = (otherImport, normalizedPath, workingDir) => otherImport.startsWith(".") ? slash(resolve3(workingDir, normalizeStoryPath(join5(dirname2(normalizedPath), otherImport)))) : otherImport, StoryIndexGenerator = class _StoryIndexGenerator {
  ...
  static async findMatchingFiles(specifier, workingDir, ignoreWarnings = !1) {
    ...
    if (cached)
      return cached;
    let pathToSubIndex = {}, globCwd = slash(resolve3(workingDir, specifier.directory)), globPattern = specifier.files.startsWith("!") ? `./${specifier.files}` : specifier.files, { globby } = await import("../_node-chunks/globby-XM3OX45H.js"), files = await globby(globPattern, {
      absolute: !0,
      cwd: globCwd,
