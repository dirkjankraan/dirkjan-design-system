import CJS_COMPAT_NODE_URL_jwouvknhbe from 'node:url';
import CJS_COMPAT_NODE_PATH_jwouvknhbe from 'node:path';
import CJS_COMPAT_NODE_MODULE_jwouvknhbe from "node:module";

var __filename = CJS_COMPAT_NODE_URL_jwouvknhbe.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_jwouvknhbe.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_jwouvknhbe.createRequire(import.meta.url);

// ------------------------------------------------------------
// end of CJS compatibility banner, injected by Storybook's esbuild configuration
// ------------------------------------------------------------
import "./_node-chunks/chunk-VXCZO3DG.js";
...
async function webpack(webpackConfig = {}, options) {
  let { module = {} } = webpackConfig, { csfPluginOptions = {}, mdxPluginOptions = {} } = options, enrichCsf = await options.presets.apply("experimental_enrichCsf"), rehypeSlug = (await import("./_node-chunks/rehype-slug-ABS4Z5YB.js")).default, rehypeExternalLinks = (await import("./_node-chunks/rehype-external-links-QO3SDH5X.js")).default, mdxLoaderOptions = await options.presets.apply("mdxLoaderOptions", {
    ...mdxPluginOptions,
    mdxCompileOptions: {
...
var docs = (input = {}, options) => {
  ...
  let { plugins = [] } = config, { mdxPlugin } = await import("./_node-chunks/mdx-plugin-JEJ3AUKQ.js"), { react, reactDom, mdx } = await getResolvedReact(options), packageDeduplicationPlugin = {
